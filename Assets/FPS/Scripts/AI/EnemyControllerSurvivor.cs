...
namespace Unity.FPS.AI
{
    ...
    public class EnemyControllerSurvivor : MonoBehaviour, IEnemyController
    {
        ...
        public GameObject KnownDetectedTarget => SurvivorDetectionModule.KnownDetectedTarget;
        public bool IsTargetInAttackRange => SurvivorDetectionModule.IsTargetInAttackRange;
        public bool IsSeeingTarget => SurvivorDetectionModule.IsSeeingTarget;
        public bool HadKnownTarget => SurvivorDetectionModule.HadKnownTarget;
        public NavMeshAgent NavMeshAgent { get; private set; }
        public SurvivorDetectionModule SurvivorDetectionModule { get; private set; }
        ...
        void Start()
        {
            ...
            spm = GameLogic.GetComponent<SpawnManager>();

            m_EnemyManager = FindObjectOfType<EnemyManager>();
            DebugUtility.HandleErrorIfNullFindObject<EnemyManager, EnemyControllerSurvivor>(m_EnemyManager, this);

            m_ActorsManager = FindObjectOfType<ActorsManager>();
            DebugUtility.HandleErrorIfNullFindObject<ActorsManager, EnemyControllerSurvivor>(m_ActorsManager, this);

            m_EnemyManager.RegisterEnemy(this);

            m_Health = GetComponent<Health>();
            DebugUtility.HandleErrorIfNullGetComponent<Health, EnemyControllerSurvivor>(m_Health, this, gameObject);

            m_Actor = GetComponent<Actor>();
            DebugUtility.HandleErrorIfNullGetComponent<Actor, EnemyControllerSurvivor>(m_Actor, this, gameObject);

            NavMeshAgent = GetComponent<NavMeshAgent>();
            m_SelfColliders = GetComponentsInChildren<Collider>();

            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, EnemyControllerSurvivor>(m_GameFlowManager, this);
            ...
            var SurvivorDetectionModules = GetComponentsInChildren<SurvivorDetectionModule>();
            DebugUtility.HandleErrorIfNoComponentFound<SurvivorDetectionModule, EnemyControllerSurvivor>(SurvivorDetectionModules.Length, this,
                gameObject);
            DebugUtility.HandleWarningIfDuplicateObjects<SurvivorDetectionModule, EnemyControllerSurvivor>(SurvivorDetectionModules.Length,
                this, gameObject);
            // Initialize detection module
            SurvivorDetectionModule = SurvivorDetectionModules[0];
            SurvivorDetectionModule.onDetectedTarget += OnDetectedTarget;
            SurvivorDetectionModule.onLostTarget += OnLostTarget;
            onAttack += SurvivorDetectionModule.OnAttack;
        ...
        void Update()
        {
            ...
            SurvivorDetectionModule.HandleTargetDetection(m_Actor, m_SelfColliders);
        ...
        void OnDamaged(float damage, GameObject damageSource)
        {
            ...
            if (damageSource && !damageSource.GetComponent<EnemyControllerSurvivor>())
            {
                // pursue the player
                SurvivorDetectionModule.OnDamaged(damageSource);
        ...
        void OnDie()
        {
            ...
            spm.IncrementEnemiesEliminated();
        ...
        void OnDrawGizmosSelected()
        {
            ...
            if (SurvivorDetectionModule != null)
            {
                // Detection range
                Gizmos.color = DetectionRangeColor;
                Gizmos.DrawWireSphere(transform.position, SurvivorDetectionModule.DetectionRange);

                // Attack range
                Gizmos.color = AttackRangeColor;
                Gizmos.DrawWireSphere(transform.position, SurvivorDetectionModule.AttackRange);
            }
        }
        ...
        void FindAndInitializeAllWeapons()
        {
            ...
            if (m_Weapons == null)
            {
                ...
                DebugUtility.HandleErrorIfNoComponentFound<WeaponController, EnemyControllerSurvivor>(m_Weapons.Length, this,
                    gameObject);
        ...
        public WeaponController GetCurrentWeapon()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<WeaponController, EnemyControllerSurvivor>(m_CurrentWeapon, this,
                gameObject);
